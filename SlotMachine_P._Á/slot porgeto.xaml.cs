    ...
    public partial class SpinWindow : Window
    {
        ...
        private void Spin()
        {
            ...
            if (reelCount >= 3)
            {
                ...
                {
                    if (results[i] == results[i + 1] && results[i] == results[i + 2] && results[i] == results[i+3])
                    {
                        negyEgymasMellett = true;
                        break;
                    }
                }
            }
            ...
            if (fullMatch)
            {
                ...
                else balance += spinCost * 4*failCount;
                failCount = 0;
